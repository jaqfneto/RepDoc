     ...
     <?php  
        ...
        if (isset($_GET['mode'])){
         $mode=filter_input(INPUT_GET,'mode',FILTER_SANITIZE_STRING);
          ...
          if (login_check($mysqli) == true) $mode="conf";
          else  $mode="normal";
        }
    ...
    <div class="BorderBorder"><div class="BorderBL"><div></div></div><div class="BorderBR"><div></div></div><div class="BorderTL"></div><div class="BorderTR"><div></div></div><div class="BorderT"></div><div class="BorderR"><div></div></div><div class="BorderB"><div></div></div><div class="BorderL"></div><div class="BorderC"></div><div class="Border">
        ...
        <div class="Header">
          <div class="HeaderTitle" >
            ...
            <h1><a href="docrep_config.php"><img src="images/logo-lnec.gif" alt="DocRep-LNEC"></a></h1>
            <h2>DocRep - Repositório de Relatórios e Documentos de Missões do LNEC</h2>
               </div>
             <div style="text-align:right; width: 25%; display: inline; float:right">
           
                <?php 
                if ($mode=="conf"){
                    //Se está em modo conf  apresenta butões: registo e login/logout
                if (login_check($mysqli) != true){
                 echo "<a href=\"#\" class=\"MenuButton\" onclick=\"login()\"><span>Login</span></a>";
                }
                else 
                {
                 echo "<a href=\"#\" class=\"MenuButton\" onclick=\"logout()\"><span>Logout</span></a>";
                }
                }
                ?>
            ...
            <ul><li><a href="docrep_config.php" class="ActiveMenuButton"><span>Home</span></a></li> 
                <li><a href="#" class="MenuButton" onclick="showMissions()"><span>Missões</span></a></li>
                <?php 
                if ((login_check($mysqli) == true)&& ($mode=="conf")){
                    //Se está em modo conf e está login então apresenta opções do menu privadas
                 echo "<li><a href=\"#\" class=\"MenuButton\" onclick=\"novaMissao()\"><span>Nova Missão</span></a></li>";
                 echo "<li><a href=\"#\" class=\"MenuButton\" onclick=\"showMissions()\"><span>Editar Missão</span></a></li>";
                 echo "<li><a href=\"#\" class=\"MenuButton\" onclick=\"IndexDbMissions()\"><span>Indexer</span></a></li>"; 
                }
                ?>
                <li><a href="#" class="MenuButton"  onclick="showHelp()"><span>Ajuda</span></a></li> 
            </ul>
